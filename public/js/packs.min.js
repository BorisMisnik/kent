...
!function(){var a,b,c,d,e,f,g,h,i,j=[].slice,k={}.hasOwnProperty,l=function(a,b){function c(){this.constructor=a}for(var d in b)k.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a};for(Function.prototype.define=function(a,b){return Object.defineProperty(this.prototype,a,b)},h=function(a,b,c){var d,e,f,g,h,i;for(arguments.length<3&&(h=["undefined"!=typeof exports?exports:window].concat(j.call(arguments)),a=h[0],b=h[1],c=h[2]),e=a,i=b.split("."),f=0,g=i.length;g>f;f++)d=i[f],a=a[d]||(a[d]={});return c(a,e)},i=function(a,b){return a.length<b?i("0"+a,b):a},b=function(){function a(a){this.host=a,null==this.host&&(this.host="./")}return a.prototype.assets={},a.prototype.items={},a.prototype.addAssetURL=function(a,b){return this.assets[a]=this.host+b},a.prototype.getAssetURL=function(a){return this.items[a]},a.prototype.getManifest=function(){var a,b,c,d;c=[],d=this.assets;for(a in d)b=d[a],c.push({id:a,src:b});return c},a.prototype.loadAssets=function(a){var b,c,d,e,f,g,h,i=this;b=a.complete,c=a.error,h=a.progress,e=function(a){var b,c,d;return b=a.item,d=a.type,c=a.result,d===createjs.LoadQueue.JAVASCRIPT&&document.body.appendChild(c),i.items[a.item.id]=a.result},f=function(a){return"function"==typeof h?h(a.loaded):void 0},d=function(a){return"function"==typeof b?b(a):void 0},this.queue=new createjs.LoadQueue(!1),this.queue.setMaxConnections(10),this.queue.addEventListener("complete",d),this.queue.addEventListener("fileload",e),this.queue.addEventListener("progress",f),g=this.getManifest(),this.queue.loadManifest(g)},a}(),h("kent.packs",function(a){return a.assetsManager=new b}),g=0;107>g;)e="pb_rotate_"+i(g.toString(),3),f="img/packs/pb_rotate_"+i(g.toString(),3)+".png",kent.packs.assetsManager.addAssetURL(e,f),g++;for(g=118;132>g;)e="pb_open_"+i(g.toString(),3),f="img/packs/pb_open_"+i(g.toString(),3)+".png",kent.packs.assetsManager.addAssetURL(e,f),g++;for(g=224;236>g;)e="pb_sig_"+i(g.toString(),3),f="img/packs/pb_sig_"+i(g.toString(),3)+".png",kent.packs.assetsManager.addAssetURL(e,f),g++;for(g=251;471>g;)e="pb_filters_"+i(g.toString(),3),f="img/packs/pb_filters_"+i(g.toString(),3)+".png",kent.packs.assetsManager.addAssetURL(e,f),g++;d=function(a){function b(){this.initialize()}return l(b,a),b.prototype._maskLeft=0,b.prototype._maskRight=0,b.prototype.initialize=function(){var a,c,d,e;for(b.__super__.initialize.apply(this,arguments),c=[],a=[],g=0,d=0;107>g;)c.push(kent.packs.assetsManager.getAssetURL("pb_rotate_"+i(g.toString(),3))),a.push([0,0,978,550,d,0,0]),g++,d++;for(g=118;132>g;)c.push(kent.packs.assetsManager.getAssetURL("pb_open_"+i(g.toString(),3))),a.push([0,0,978,550,d,0,0]),g++,d++;for(g=224;236>g;)c.push(kent.packs.assetsManager.getAssetURL("pb_sig_"+i(g.toString(),3))),a.push([0,0,978,550,d,0,0]),g++,d++;for(g=251;471>g;)c.push(kent.packs.assetsManager.getAssetURL("pb_filters_"+i(g.toString(),3))),a.push([0,0,978,550,d,0,0]),g++,d++;return this.spriteSheet=new createjs.SpriteSheet({images:c,frames:a,animations:{rotate:[0,106],open:[107,120],sig:[121,132],filter:[133,353],sig_filter:[121,353]}}),this.img=new createjs.BitmapAnimation(this.spriteSheet),e=.95,this.img.scaleX=e,this.img.scaleY=e,this.img.x=-978*e/2,this.img.y=-550*e/2,this.img.gotoAndStop(0),this.maskWidth=1e3,this._mask=new createjs.Shape,this._mask.graphics.beginFill(createjs.Graphics.getRGB(0,255,0,.5)).drawRect(0,0,this.maskWidth-this._maskLeft-this._maskRight,550),this._mask.x=-this.maskWidth/2+this._maskLeft,this._mask.y=-275,this.img.mask=this._mask,this.addChild(this.img)},b.prototype._frame=0,b.define("frame",{get:function(){return this._frame},set:function(a){return this._frame=a>this._frame?Math.ceil(a):Math.floor(a),this._frame=106===this._frame?0:this._frame,this.img.gotoAndStop(this._frame)}}),b.define("maskLeft",{get:function(){return this._maskLeft},set:function(a){return this._maskLeft=a,this._mask.graphics.clear().beginFill(createjs.Graphics.getRGB(0,255,0,.5)).drawRect(0,0,this.maskWidth-this._maskLeft-this._maskRight,550),this._mask.x=-this.maskWidth/2+this._maskLeft}},b.define("maskRight",{get:function(){return this._maskRight},set:function(a){return this._maskRight=a,this._mask.graphics.clear().beginFill(createjs.Graphics.getRGB(0,255,0,.5)).drawRect(0,0,this.maskWidth-this._maskLeft-this._maskRight,550),this._mask.x=-this.maskWidth/2+this._maskLeft}})),b}(createjs.Container),h("kent.packs.views",function(a){return a.PackSpiteSheet=d}),kent.packs.assetsManager.addAssetURL("i_360","img/i360.png"),kent.packs.assetsManager.addAssetURL("i_open","img/iOpen.png"),kent.packs.assetsManager.addAssetURL("i_sig","img/iSig.png"),c=function(a){function b(){this.initialize()}return l(b,a),b.prototype.pss=null,b.prototype.initialize=function(){var a,c,d,e,f,g,h=this;return b.__super__.initialize.apply(this,arguments),this.pss=new kent.packs.views.PackSpiteSheet,this.pss._mask.visible=!1,this.pss2=new kent.packs.views.PackSpiteSheet,this.pss2.visible=!1,kent.packs.app.pss2=this.pss2,this.pack_rotator=new createjs.Shape,this.pack_rotator.graphics.beginFill(createjs.Graphics.getRGB(0,255,0,0)).drawRect(0,0,220,280),this.pack_rotator.hitArea=new createjs.Shape((new createjs.Graphics).beginFill("#000").drawRect(0,0,220,280)),this.pack_rotator.x=-110,this.pack_rotator.y=-60,this.pack_opener=new createjs.Shape,this.pack_opener.graphics.beginFill(createjs.Graphics.getRGB(255,0,0,0)).drawRect(0,0,220,140),this.pack_opener.hitArea=new createjs.Shape((new createjs.Graphics).beginFill("#000").drawRect(0,0,220,140)),this.pack_opener.x=-110,this.pack_opener.y=-200,this.pack_closr=new createjs.Shape,this.pack_closr.graphics.beginFill(createjs.Graphics.getRGB(0,0,255,0)).drawRect(0,0,220,70),this.pack_closr.hitArea=new createjs.Shape((new createjs.Graphics).beginFill("#000").drawRect(0,0,220,70)),this.pack_closr.x=-110,this.pack_closr.y=-270,this.pack_closr.visible=!1,this.fltr_btn_1=new createjs.Shape,this.fltr_btn_1.graphics.beginFill(createjs.Graphics.getRGB(0,255,0,0)).drawRect(-100,-75,200,150),this.fltr_btn_1.hitArea=new createjs.Shape((new createjs.Graphics).beginFill("#000").drawRect(-100,-75,200,150)),this.fltr_btn_1.y=40,this.fltr_btn_2=new createjs.Shape,this.fltr_btn_2.graphics.beginFill(createjs.Graphics.getRGB(0,255,0,0)).drawRect(-100,-75,200,150),this.fltr_btn_2.hitArea=new createjs.Shape((new createjs.Graphics).beginFill("#000").drawRect(-100,-75,200,150)),this.fltr_btn_2.y=40,this.fltr_btn_2.x=-280,this.fltr_btn_3=new createjs.Shape,this.fltr_btn_3.graphics.beginFill(createjs.Graphics.getRGB(0,255,0,0)).drawRect(-100,-75,200,150),this.fltr_btn_3.hitArea=new createjs.Shape((new createjs.Graphics).beginFill("#000").drawRect(-100,-75,200,150)),this.fltr_btn_3.y=40,this.fltr_btn_3.x=280,this.fltr_btn_1.visible=this.fltr_btn_2.visible=this.fltr_btn_3.visible=!1,this.title=new createjs.Text("Унікальний трисекційний фільтр".toUpperCase(),"20px Verdana","#6B747A"),this.title.textAlign="center",this.title.x=0,this.title.y=-130,this.title_fltr_1=new createjs.Text("Вугільний фільтр".toUpperCase(),"18px Verdana","#6B747A"),this.title_fltr_1.textAlign="center",this.title_fltr_1.x=-280,this.title_fltr_1.y=150,this.title_fltr_sbt_1=new createjs.Text("Забезпечує м'який смак".toUpperCase(),"11px Verdana","#6B747A"),this.title_fltr_sbt_1.textAlign="center",this.title_fltr_sbt_1.x=-280,this.title_fltr_2=new createjs.Text("Надтонке волокно".toUpperCase(),"18px Verdana","#6B747A"),this.title_fltr_2.textAlign="center",this.title_fltr_2.y=150,this.title_fltr_sbt_2=new createjs.Text("Робить смак рівномірним".toUpperCase(),"11px Verdana","#6B747A"),this.title_fltr_sbt_2.textAlign="center",this.title_fltr_3=new createjs.Text("Турбо-фільтр".toUpperCase(),"18px Verdana","#6B747A"),this.title_fltr_3.textAlign="center",this.title_fltr_3.x=280,this.title_fltr_3.y=150,this.title_fltr_sbt_3=new createjs.Text("Миттєва передача смаку".toUpperCase(),"11px Verdana","#6B747A"),this.title_fltr_sbt_3.textAlign="center",this.title_fltr_sbt_3.x=280,this.title_fltr_sbt_1.y=this.title_fltr_sbt_2.y=this.title_fltr_sbt_3.y=180,this.title.alpha=this.title_fltr_1.alpha=this.title_fltr_2.alpha=this.title_fltr_3.alpha=this.title_fltr_sbt_1.alpha=this.title_fltr_sbt_2.alpha=this.title_fltr_sbt_3.alpha=0,d=231,e=243,a=273,c=287,f=318,g=327,this.fltr_btn_1.addEventListener("mouseover",function(){return TweenMax.fromTo(h.pss2,c-a,{frame:a},{frame:c,useFrames:!0}),TweenMax.to(h.title_fltr_sbt_2,1,{alpha:1,ease:Sine.easeOut})}),this.fltr_btn_1.addEventListener("mouseout",function(){return TweenMax.fromTo(h.pss2,c-a,{frame:c},{frame:a,useFrames:!0})}),this.fltr_btn_2.addEventListener("mouseover",function(){return TweenMax.fromTo(h.pss2,e-d,{frame:d},{frame:e,useFrames:!0}),TweenMax.to(h.title_fltr_sbt_1,1,{alpha:1,ease:Sine.easeOut})}),this.fltr_btn_2.addEventListener("mouseout",function(){return TweenMax.fromTo(h.pss2,e-d,{frame:e},{frame:d,useFrames:!0})}),this.fltr_btn_3.addEventListener("mouseover",function(){return TweenMax.fromTo(h.pss2,g-f,{frame:f},{frame:g,useFrames:!0}),TweenMax.to(h.title_fltr_sbt_3,1,{alpha:1,ease:Sine.easeOut})}),this.fltr_btn_3.addEventListener("mouseout",function(){return TweenMax.fromTo(h.pss2,g-f,{frame:g},{frame:f,useFrames:!0})}),this.i_360=new createjs.Bitmap(kent.packs.assetsManager.getAssetURL("i_360")),this.i_360.x=-162,this.i_360.y=170,this.i_open_1=new createjs.Bitmap(kent.packs.assetsManager.getAssetURL("i_open")),this.i_open_1.x=-100,this.i_open_1.y=-110,this.i_open_2=new createjs.Bitmap(kent.packs.assetsManager.getAssetURL("i_open")),this.i_open_2.x=-26,this.i_open_2.y=-115,this.i_open_2.alpha=0,this.i_sig=new createjs.Bitmap(kent.packs.assetsManager.getAssetURL("i_sig")),this.i_sig.x=280,this.i_sig.y=-26,this.i_sig.alpha=0,this.addChild(this.i_360,this.pss,this.pss2,this.i_open_1,this.i_open_2,this.i_sig,this.pack_opener,this.pack_closr,this.pack_rotator,this.fltr_btn_1,this.fltr_btn_2,this.fltr_btn_3,this.title,this.title_fltr_1,this.title_fltr_2,this.title_fltr_3,this.title_fltr_sbt_1,this.title_fltr_sbt_2,this.title_fltr_sbt_3),this.state_machine=StateMachine.create({inital:"none",events:[{name:"rotate",from:"*",to:"rotation"},{name:"open",from:"rotation",to:"opening"},{name:"getsig",from:["rotation","opening"],to:"sig"},{name:"rotatesig",from:["sig"],to:"rotatedsig"},{name:"openfilter",from:["rotatedsig"],to:"openedfilter"},{name:"previewfilter",from:["openedfilter"],to:"filterbtns"}],callbacks:{onenterrotation:function(){return console.log("enter rotation"),h.pack_closr.visible=!1,h.pack_rotator.addEventListener("mousedown",function(a){var b,c;return h.pack_opener.visible=!1,TweenMax.to(h.i_open_1,.5,{alpha:0}),b=a.stageX,c=a.stageY,h.pack_rotator.getStage().addEventListener("stagemousemove",function(a){var d,e,f;return d=b-a.stageX,e=c-a.stageY,b=a.stageX,c=a.stageY,f=h.pss.frame+d/4,f=0>f?106+f:f>106?f-106:f,h.pss.frame=f}),h.pack_rotator.getStage().addEventListener("stagemouseup",function(){var a,b;return console.log("@pack_rotator stagemouseup"),h.pack_rotator.getStage().removeAllEventListeners("stagemousemove"),h.pack_rotator.getStage().removeAllEventListeners("stagemouseup"),a=h.pss.frame>53?106:0,b=0===a?h.pss.frame:a-h.pss.frame,TweenMax.to(h.pss,b,{frame:a,useFrames:!0,ease:Linear.easeNone,onComplete:function(){return h.pack_opener.visible=!0,TweenMax.to(h.i_open_1,.5,{alpha:1})}})})}),h.pack_opener.addEventListener("mousedown",function(a){var b,c;return TweenMax.to(h.i_open_1,.5,{alpha:0}),h.pack_rotator.visible=!1,b=a.stageX,c=a.stageY,h.pack_opener.getStage().addEventListener("stagemousemove",function(a){var d,e,f;return d=b-a.stageX,e=c-a.stageY,b=a.stageX,c=a.stageY,f=h.pss.frame+e/4,f=107>f?107:f>120?120:f,h.pss.frame=f}),h.pack_opener.getStage().addEventListener("stagemouseup",function(){var a;return console.log("@pack_opener stagemouseup"),h.pack_opener.getStage().removeAllEventListeners("stagemousemove"),h.pack_opener.getStage().removeAllEventListeners("stagemouseup"),h.pss.frame>115?(a=120-h.pss.frame,TweenMax.to(h.pss,a,{frame:120,ease:Linear.easeNone,useFrames:!0,onComplete:function(){return h.state_machine.getsig()}})):TweenMax.to(h.pss,a,{frame:107,ease:Linear.easeNone,useFrames:!0,onComplete:function(){return h.pack_rotator.visible=!0}})})}),TweenMax.to(h.i_360,.5,{alpha:1}),TweenMax.to(h.i_open_1,.5,{alpha:1}),TweenMax.to(h.i_open_2,.5,{alpha:0})},onleaverotation:function(){return console.log("leave rotation"),TweenMax.to(h.i_360,.5,{alpha:0}),h.pack_opener.visible=!1,h.pack_rotator.visible=!1,h.pack_opener.removeAllEventListeners("mousedown"),h.pack_rotator.removeAllEventListeners("mousedown")},onenteropen:function(){return console.log("enter open"),console.log("on enter open")},onentersig:function(){return console.log("enter sig"),h.pss2.y=6,h.pss2.frame=121,h.pss2.visible=!0,h.pss2.rotation=-90,h.pss2.scaleX=h.pss2.scaleY=.597,h.pss2.maskLeft=690,h.pack_opener.visible=!0,h.pack_closr.visible=!0,h.pack_closr.addEventListener("mousedown",function(a){var b,c;return h.pss2.visible=!1,h.pack_rotator.visible=!1,b=a.stageX,c=a.stageY,h.pack_closr.getStage().addEventListener("stagemousemove",function(a){var d,e,f;return d=b-a.stageX,e=c-a.stageY,b=a.stageX,c=a.stageY,f=h.pss.frame+e/4,f=107>f?107:f>120?120:f,h.pss.frame=f,console.log(f)}),h.pack_closr.getStage().addEventListener("stagemouseup",function(){var a;return console.log("@@pack_closr close pack"),h.pack_opener.getStage().removeAllEventListeners("stagemousemove"),h.pack_opener.getStage().removeAllEventListeners("stagemouseup"),h.pss.frame>115?(a=120-h.pss.frame,TweenMax.to(h.pss,a,{frame:120,ease:Linear.easeNone,useFrames:!0,onComplete:function(){return h.state_machine.getsig()}})):TweenMax.to(h.pss,a,{frame:107,ease:Linear.easeNone,useFrames:!0,onComplete:function(){return h.state_machine.rotate(),h.pack_rotator.visible=!0}})})}),h.pack_opener.addEventListener("mousedown",function(a){var b,c;return b=a.stageX,c=a.stageY,h.pack_opener.getStage().addEventListener("stagemousemove",function(a){var d,e,f;return console.log("@pack_opener : sig"),d=b-a.stageX,e=c-a.stageY,b=a.stageX,c=a.stageY,f=h.pss2.y-e,7>f?(h.pss2.y=f,h.pss2.maskLeft-=1*e/.597):void 0}),h.pack_opener.getStage().addEventListener("stagemouseup",function(){return h.pack_opener.getStage().removeAllEventListeners("stagemousemove"),h.pack_opener.getStage().removeAllEventListeners("stagemouseup"),h.pss2.y>-50?TweenMax.to(h.pss2,.5,{y:6,maskLeft:690}):(h.pack_opener.visible=!1,h.pack_closr.visible=!1,h.pack_opener.removeAllEventListeners("mousedown"),h.pack_opener.getStage().removeAllEventListeners("stagemousemove"),TweenMax.to(h.pss,1.5,{y:1e3}),TweenMax.to(h.pss2,.5,{maskLeft:0,y:0,onComplete:function(){return h.state_machine.rotatesig()}}),TweenMax.to(h.i_open_2,.5,{alpha:0}))})}),TweenMax.to(h.i_open_2,.5,{alpha:1})},onleavesig:function(){return console.log("leave sig"),h.pack_closr.removeAllEventListeners("mousedown"),h.pack_opener.removeAllEventListeners("mousedown"),h.pack_opener.getStage().removeAllEventListeners("stagemousemove"),h.pack_opener.getStage().removeAllEventListeners("stagemouseup")},onenterrotatedsig:function(){return TweenMax.to(h.pss2,.5,{scaleX:1,scaleY:1,rotation:0,onComplete:function(){return TweenMax.to(h.i_sig,.5,{alpha:1})}}),h.pack_opener.getStage().addEventListener("click",function(){return h.state_machine.openfilter()})},onenteropenedfilter:function(){return TweenMax.to(h.i_sig,.5,{alpha:0}),h.pack_opener.getStage().removeAllEventListeners("click"),console.log(h.pss2.frame),TweenMax.to(h.pss2,220,{frame:231,ease:Linear.easeNone,useFrames:!0,onComplete:function(){return h.state_machine.previewfilter()}}),TweenMax.to(h.title,.5,{alpha:1}),TweenMax.to(h.title_fltr_1,1,{alpha:1,delay:3,ease:Sine.easeOut}),TweenMax.to(h.title_fltr_2,1,{alpha:1,delay:3.5,ease:Sine.easeOut}),TweenMax.to(h.title_fltr_3,1,{alpha:1,delay:4,ease:Sine.easeOut})},onenterfilterbtns:function(){return h.fltr_btn_1.visible=h.fltr_btn_2.visible=h.fltr_btn_3.visible=!0}}}),this.state_machine.rotate(),console.log(this.state_machine.current)},b}(createjs.Container),h("kent.packs.views",function(a){return a.PackComposition=c}),a=function(){function a(){}return a.prototype.stage=null,a.prototype.stageWidth=1e3,a.prototype.stageHeight=700,a.prototype.initStage=function(){var a=this;return console.log("initStage "+this.stageWidth+", "+this.stageHeight),this.stage=new createjs.Stage("app-canvas"),this.stage.enableMouseOver(20),this.preload_label=new createjs.Text("0%".toUpperCase(),"22px Verdana","#6B747A"),this.preload_label.textAlign="center",this.preload_label.x=this.stageWidth/2,this.preload_label.y=this.stageHeight/2,this.stage.addChild(this.preload_label),TweenMax.ticker.fps(60),TweenMax.ticker.addEventListener("tick",this.stage.update,this.stage),kent.packs.assetsManager.loadAssets({complete:function(){var b;return b=new kent.packs.views.PackComposition,b.x=a.stageWidth/2,b.y=a.stageHeight/2,a.stage.addChild(b),console.log("COMPLETE"),a.preload_label.visible=!1},progress:function(b){return a.preload_label.text=""+Math.round(100*b)+"%"},error:function(){}})},a}(),h("kent.packs",function(b){return b.app=new a}),kent.packs.app.initStage()}.call(this);